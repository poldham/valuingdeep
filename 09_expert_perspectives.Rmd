...
![Figure 7.1: Distribution of Delphi Study Participants by Country](Images/distribution_of_delphi_study_participants_by_country.png)
...
__Figure 7.2: Participants by Organisation Type__

```{r echo = FALSE, message = FALSE}

participants <- data.frame(
Country = c("Australia", "Belgium", "Brazil", "Chile", "Fiji", "France", "International", "Ireland", "Israel", "Italy", "Japan", "Mauritius", "Namibia", "Netherlands", "Norway", "Palau", "Portugal", "UK", "USA"),

"University or Institute" = c("2", "1", "1", "1", " ", "2", " ", "1", "1", "1", "1", " ", " ", " ", "1", " ", "1", "7", "8"),

"Conservation Organisation" = c(" ", " ", " ", " ", " ", " ", "1", " ", " ", " ", " ", "1", " ", "1* ", " ", " ", " ", "1", " "),
Government = c("", "", "", "", "1*", "", "", "", "", "", "", "", "1", "", "", "1", "", "", "1"), 
"Private Sector" = c("", "1", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "2", "1*" ), check.names = FALSE
)
...
__Economic Interest and Potential__
...
__Habitats and Human Impacts__
...
__Access to Marine Genetic Resources__
...
> “I do not consider that 'genes' should be patentable.”
“The open oceans are the commons and should be used for the benefit of all mankind.”
...
__Capacity Building and Technology Transfer__
